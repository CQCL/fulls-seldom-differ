...
module _ {s0 b0 s1 b1 : Two} where
  ...
  -- Lemma 6.7 (Friendly-Friendly):
  -- We can solve equations of ZBDs, producing a pullback made of ZBD.
  -- The sides here are called "friendly words" (Definition 6.4)
...
-- Lemma 6.9: A rectifier for solving foes.
...
-- An equation with an "incident" (Definition 6.4) and a "friend" can be solved
-- in terms of a "friend" and a sequence of fulls
...
-- Lemma 6.11 (Incident Pullbacks): Solve an equation of two incidents
rectFZBDS : Rectifier
...
-- Turn a general arrow into a foe followed by a friend
...
-- Theorem 6.6 (Pullbacks): This is the general solver for all of ZBSDF
